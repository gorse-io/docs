...
This evaluation uses the GitHub playground dataset from [GitRec](https://gitrec.gorse.io/). The dataset contains GitHub users, repositories, and interactions between users and repositories. Follow the [Quick Start guide](../docs/quick-start.md#option-1-setup-gorse-in-one-node-via-playground) to import the dataset.
